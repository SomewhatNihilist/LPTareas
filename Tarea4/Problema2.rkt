...
(define (triangular_cola numero)
  (let tri ((n numero) (i 1))
    (if (positive? n)
        (tri (- n i) (+ i 1))
        (if (zero? n) #t #f) ; Zero: is triangular #t. Negative: didn't fit #f.
        )
    )
  )
...
; Triangulares hasta 630
(andmap triangular_cola '(0 1 3 6 10 15 21 28 36 45 55 66 78 91 105 120 136 153 171
                         190 210 231 253 276 300 325 351 378 406 435 465 496 528
                         561 595 630))
; No-triangulares hasta 644
(ormap triangular_cola '(2 4 5 7 8 9 11 12 13 14 16 17 18 19 20 22 23 24 25 26 27
                         29 30 31 32 33 34 35 37 38 39 40 41 42 43 44 46 47 48
                         49 50 51 52 53 54 56 57 58 59 60 61 62 63 64 65 67 68
